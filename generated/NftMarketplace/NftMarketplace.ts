...
export class ItemCanceld extends ethereum.Event {
  get params(): ItemCanceld__Params {
    return new ItemCanceld__Params(this);
  }
}

export class ItemCanceld__Params {
  _event: ItemCanceld;

  constructor(event: ItemCanceld) {
    this._event = event;
  }
